...
`BeirDatasetReader::from_hf("beir_nfcorpus")`, but keeping it here for now
- as en example of how to load BEIR datasets using alternative way
- and to be able to test this way easily
